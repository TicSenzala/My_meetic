...
<body>
	...
	<div class="container mt-4 head--profile">
		<img src="Image/user.png" alt="logo settings">
		<h1 class="mt-2"><?php echo $_SESSION['prenom'] .' '. $_SESSION['nom']?></h1>
	</div>
	<form method="POST" action="#">
		<div class="container">
			<h2 class="mt-5">Changer de sexe :</h2>
			<select class="form-control mt-3" name="newsexe">
				<option>Homme</option>
				<option>Femme</option>
				<option>Autre</option>
			</select>
			<input type="email" name="email" placeholder="@" class="form-control col-md-3 mt-2">

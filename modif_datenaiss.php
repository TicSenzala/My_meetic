...
<html lang="fr">
<head>
	<title>Modif date de naissance</title>
	<meta charset="utf-8">
...
<body>
	...
	<form method="POST" action="#">
		<div class="container col-md-6">
			<h2 class="mt-5">Changez votre date de naissance :</h2>
			<input type="date" name="newdatenaiss" class="form-control mt-3">
			<input type="email" name="email" class="form-control mt-3 col-md-3" placeholder="@">

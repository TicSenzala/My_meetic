...
<html lang="fr">
<head>
	<title>Modif nom et prénom</title>
	<meta charset="utf-8">
...
<body>
	...
	<form action="#" method="POST">
		<div class="container col-md-6">
			<h2 class="mt-5">Modifier votre nom et/ou prénom :</h2>
			<input type="text" name="newnom" placeholder="Nom" class="form-control col-md-6 mt-4">
			<input type="text" name="newprenom" placeholder="Prenom" class="form-control col-md-6 mt-3">
			<input type="email" name="email" placeholder="@" class="form-control col-md-3 mt-3">
			<input type="submit" name="envoyer" class="btn btn-success mt-1 col-md-2 float-right m-2">
		</div>
	</form>
